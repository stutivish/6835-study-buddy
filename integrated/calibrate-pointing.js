...
*/ 
  ...
  Leap.loop({background: true}, {
    hand: function (hand) {
      // get all the fingers from the hand
      ...
      // if only the index finger is extended, it's a pointing gesture
      ...
      if (isPointing) {
        document.getElementById("pointing-correct").style.visibility = "visible";
      }
