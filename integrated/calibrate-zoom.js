...
*/ 
  ...
  Leap.loop({background: true}, {
    hand: function (hand) {
      ...
      if (indexFinger.extended && middleFinger.extended && ringFinger.extended && thumb.extended && pinky.extended && hand.grabStrength==0) {
        canZoom = true; 
      } else {
        canZoom = false; 
      }
      ...
      if (canZoom) {
        document.getElementById("zoom-correct").style.visibility = "visible";
      }
